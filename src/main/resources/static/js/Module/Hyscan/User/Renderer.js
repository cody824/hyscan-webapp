Ext.define('Module.Hyscan.User.Renderer', {
	...
	getUserName : function(val, u,r, rowIndex, columnIndex, s) {
		if (val != null && val.length > 0) {
			...
			return icon + '<a style="cursor:pointer;text-decoration:underline;font-style:italic;" onclick="Module.Hyscan.User.Tools.showUserInEast(\''+ r.data.name  +'\',event);">' + val + '</a>';
		} else
			return val;
	},
