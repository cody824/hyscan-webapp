Ext.define('Module.Hyscan.MaterialAlgo.view.Grid', {
    ...
    initComponent: function () {
        ...
        var store = Ext.create('Module.Hyscan.MaterialAlgo.store.ModelConfigStore');
        Ext.apply(this, {
        	selModel: sm,
            columns: columns,
            viewConfig: {
    ...
    onGoodsClick : function(view ,rowIndex, colIndex, item, e, record, row){
    	var me = this;
    	var opt = Module.Hyscan.MaterialAlgo.Operation;
